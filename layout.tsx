...
function TrustSection() {
  const pillars = [
    ...
    },
    {
      ...
      desc: 'Geen eindeloos wachten — wij zorgen voor een snelle, kwalitatieve match.',
    },
    {
      icon: <IconUsers />,
          ...
          <div className="p-8 sm:p-10 relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              {[
                ...
                { label: 'Salaris', value: '€2.800 – €3.600' },
    ...
    <footer className="relative border-t px-6 py-10" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <p className="text-xs text-center sm:text-right" style={{ color: 'rgba(245,240,232,0.25)' }}>
          © {new Date().getFullYear()} HorecaNext — Zutphen, Gelderland
